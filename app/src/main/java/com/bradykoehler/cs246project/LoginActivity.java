...
//        SharedPreferences loginData = PreferenceManager.getDefaultSharedPreferences(LoginActivity.this);
        ...
        Log.d("Login Activity", "Stored email is: " + loginEmail);
        Log.d("Login Activity", "Stored password is: " + loginPassword);

        if (loginEmail != null) {
            EditText edit = findViewById(R.id.email);
            edit.setText(loginEmail);
        }

        if (loginPassword != null) {
            EditText edit = findViewById(R.id.password);
            edit.setText(loginPassword);
        }
